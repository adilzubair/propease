        ...
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded-xl shadow-glass border border-gray-100 transition-all duration-300 hover:shadow-modern hover:-translate-y-1 group">
              ...
              <h4 className="text-xl font-bold font-['Space_Grotesk'] leading-snug tracking-tight mb-2 text-gray-900 transition-all duration-300 group-hover:text-blue-600">Property Onboarding</h4>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded-xl shadow-glass border border-gray-100 transition-all duration-300 hover:shadow-modern hover:-translate-y-1 group">
              ...
              <h4 className="text-xl font-bold font-['Space_Grotesk'] leading-snug tracking-tight mb-2 text-gray-900 transition-all duration-300 group-hover:text-blue-600">Tenant Management</h4>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded-xl shadow-glass border border-gray-100 transition-all duration-300 hover:shadow-modern hover:-translate-y-1 group">
              ...
              <h4 className="text-xl font-bold font-['Space_Grotesk'] leading-snug tracking-tight mb-2 text-gray-900 transition-all duration-300 group-hover:text-blue-600">Maintenance Tracking</h4>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded-xl shadow-glass border border-gray-100 transition-all duration-300 hover:shadow-modern hover:-translate-y-1 group">
              ...
              <h4 className="text-xl font-bold font-['Space_Grotesk'] leading-snug tracking-tight mb-2 text-gray-900 transition-all duration-300 group-hover:text-blue-600">Financial Reporting</h4>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded-xl shadow-glass border border-gray-100 transition-all duration-300 hover:shadow-modern hover:-translate-y-1 group">
              ...
              <h4 className="text-xl font-bold font-['Space_Grotesk'] leading-snug tracking-tight mb-2 text-gray-900 transition-all duration-300 group-hover:text-blue-600">Document Management</h4>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded-xl shadow-glass border border-gray-100 transition-all duration-300 hover:shadow-modern hover:-translate-y-1 group">
              ...
              <h4 className="text-xl font-bold font-['Space_Grotesk'] leading-snug tracking-tight mb-2 text-gray-900 transition-all duration-300 group-hover:text-blue-600">Analytics & Insights</h4>
