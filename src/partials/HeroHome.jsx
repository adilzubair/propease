          ...
          <div>
            <div className="relative flex justify-center mb-8" data-aos="zoom-y-out" data-aos-delay="450">
              <div className="flex flex-col justify-center">
                ...
                >
                  <defs>                    <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="hero-ill-a">
                ...
                className="absolute top-full flex items-center transform -translate-y-1/2 bg-white rounded-full font-medium group p-4 shadow-lg border-2 border-blue-600 hover:border-neon-400"
                onClick={(e) => {
                  e.preventDefault();
                  e.stopPropagation();
                ...
                aria-controls="modal"
              >
                <svg                  className="w-6 h-6 fill-current text-gray-900 group-hover:text-neon-400 flex-shrink-0"
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                >
                ...
                <span className="ml-3 font-['Lato']">Watch the full video (2 min)</span>
              </button>
            </div>
