    ...
    <footer>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            ...
            <ul className="text-sm">
              ...
              <li className="mb-2">
                <Link to="#" className="text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Support</Link>
              </li>
              <li className="mb-2">
          ...
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-3">
            ...
            <p className="text-sm text-gray-600 mb-4">Get the latest updates and news from Propease.</p>
            <form>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyright */}
          <div className="text-sm text-gray-600 mr-4">&copy; {new Date().getFullYear()} Propease. All rights reserved.</div>
        </div>
      </div>
    </footer>
  );
