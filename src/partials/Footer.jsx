      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-12 lg:col-span-3">
                ...
                <svg className="w-8 h-8" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <radialGradient cx="21.152%" cy="86.063%" fx="21.152%" fy="86.063%" r="79.941%" id="footer-logo">
                      ...
                      <stop stopColor="#39FF14" offset="60%" />
            ...
            <div className="text-sm text-gray-900 font-['Lato']">
              <Link to="#" className="text-gray-900 hover:text-blue-600 hover:underline transition duration-150 ease-in-out">Terms</Link> · <Link to="#" className="text-gray-900 hover:text-blue-600 hover:underline transition duration-150 ease-in-out">Privacy Policy</Link>
            </div>
          </div>
          ...
          {/* 4th block */}
          <div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
            <h6 className="text-gray-900 font-['Space_Grotesk'] font-medium mb-2">Company</h6>
            <ul className="text-sm font-['Lato']">
              <li className="mb-2">
                <Link to="#" className="text-gray-900 hover:text-blue-600 transition duration-150 ease-in-out">Home</Link>
              </li>
              <li className="mb-2">
                <Link to="#" className="text-gray-900 hover:text-blue-600 transition duration-150 ease-in-out">About us</Link>
              </li>
              <li className="mb-2">
                <Link to="#" className="text-gray-900 hover:text-blue-600 transition duration-150 ease-in-out">Company values</Link>
              </li>
              <li className="mb-2">
                <Link to="#" className="text-gray-900 hover:text-blue-600 transition duration-150 ease-in-out">Pricing</Link>
              </li>
              <li className="mb-2">
                <Link to="#" className="text-gray-900 hover:text-blue-600 transition duration-150 ease-in-out">Privacy Policy</Link>
              </li>
            </ul>
          </div>
              ...
              <div className="flex flex-wrap mb-4">
                <div className="w-full">
                  ...
                  <div className="relative flex items-center max-w-xs">
                    <input id="newsletter" type="email" className="form-input w-full text-gray-900 px-3 py-2 pr-12 text-sm font-['Lato']" placeholder="Your email" required />
                    <button type="submit" className="absolute inset-0 left-auto" aria-label="Subscribe">
                      <span className="absolute inset-0 right-auto w-px -ml-px my-2 bg-gray-300" aria-hidden="true"></span>
                      <svg className="w-3 h-3 fill-current text-neon-400 mx-3 flex-shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          <ul className="flex mb-4 md:order-1 md:ml-4 md:mb-0">
            <li>
              <Link to="#" className="flex justify-center items-center text-gray-900 hover:text-blue-600 bg-white hover:border hover:border-neon-400 rounded-full shadow transition duration-150 ease-in-out" aria-label="Twitter">
            ...
            <li className="ml-4">
              <Link to="#" className="flex justify-center items-center text-gray-900 hover:text-blue-600 bg-white hover:border hover:border-neon-400 rounded-full shadow transition duration-150 ease-in-out" aria-label="Github">
                <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
            ...
            <li className="ml-4">
              <Link to="#" className="flex justify-center items-center text-gray-900 hover:text-blue-600 bg-white hover:border hover:border-neon-400 rounded-full shadow transition duration-150 ease-in-out" aria-label="Facebook">
                <svg className="w-8 h-8 fill-current" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
