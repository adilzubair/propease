...
function Features() {
  ...
  return (
    <section className="relative">
      ...
      <div className="absolute inset-0 bg-platinum-200 pointer-events-none mb-16" aria-hidden="true"></div>
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6" data-aos="fade-right">
              ...
              <div className="mb-8 md:mb-0">
                <a
                  className={`flex items-center text-lg p-5 rounded border transition duration-300 ease-in-out mb-3 ${tab !== 1 ? 'bg-white shadow-md border-gray-200 hover:shadow-lg hover:border-neon-400' : 'bg-blue-600 text-white border-transparent'}`}
                  href="#0"
                ...
                <a
                  className={`flex items-center text-lg p-5 rounded border transition duration-300 ease-in-out mb-3 ${tab !== 2 ? 'bg-white shadow-md border-gray-200 hover:shadow-lg hover:border-neon-400' : 'bg-blue-600 text-white border-transparent'}`}
                  href="#0"
                ...
                <a
                  className={`flex items-center text-lg p-5 rounded border transition duration-300 ease-in-out mb-3 ${tab !== 3 ? 'bg-white shadow-md border-gray-200 hover:shadow-lg hover:border-neon-400' : 'bg-blue-600 text-white border-transparent'}`}
                  href="#0"
